...
private:
    ...
    PSCATTER_GATHER_LIST m_SGL;

    CNB(const CNB&);
    CNB& operator= (const CNB&);
...
class CParaNdisTX : public CParaNdisTemplatePath<CTXVirtQueue>
#ifndef _WIN32_WCE
, public CNdisAllocatable<CParaNdisTX, 'XTHR'>
#endif
{
public:
	CParaNdisTX() {};
